...
// // Testes Extras
// // Teste Com Vetor de Caracteres
//     {
//         BEGIN_TEST( tm,"Reverse5", "ReversePartOfArrayOddChars");
//         char A[]{ 'a', 'b', 'c', 'd', 'e', 'f', 'g' };
//         char A_E[]{ 'g', 'f', 'e', 'd', 'c', 'b', 'a' };
...
//     {
//         BEGIN_TEST( tm,"Reverse6", "ReversePartOfArrayOddStrings");
//         string A[]{ "triangulo", "bola", "cubo"};
//         string A_E[]{ "cubo", "bola", "triangulo"};
